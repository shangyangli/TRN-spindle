# -*- coding: utf-8 -*-
"""
Created on Wed Dec 27 11:14:19 2023
...
# ---- No spindle oscillation example ---- #
if __name__ == '__main__1':
  ...
  visualiztion = False
  # gap junction weight
  gjws = [0.001]  # [0.0005,0.0008, 0.0011,0.0014,0.0015,0.0018,0.0020,0.0022,0.0023,
  Vrs = [-62.3]  # np.arange(-65.1, -64.0, 0.2)     #-65.5
  gT_sigmas = [0.8]
  gT = 2.6
    ...
    for gjw in gjws:
      for gT_sigma in gT_sigmas:
        ...
        run_net(
          ...
          method='rk4',
          report=True,
          save_path=f'./data/Fig3/Vr={Vr}/gjw={gjw}/'
        )
