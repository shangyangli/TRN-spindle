# -*- coding: utf-8 -*-
"""
Created on Thu Dec  7 10:59:30 2023
...
def run_net(
  ...
  # run the network
  inpys = bp.inputs.section_input([input1, input1, 0.], [7000., 1000., 7000])
  ...
  for i, start in enumerate(np.arange(0, run_duration, run_step)):
    ...
    # raster plot
    fig, gs = bp.visualize.get_figure(row_num=6, col_num=1, row_len=2, col_len=20)
...
if __name__ == '__main__':
  ...
  run_net(
    ...
    method='rk4',
    report=True,
    save_path=f'./Fig1207/5gT_sigmas={gT_sigma}/gjw={gjw}/'
  )